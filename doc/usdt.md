...
be found in [contrib/ebpf-tracing].

[bpftrace]: https://github.com/iovisor/bpftrace
[BPF Compiler Collection (BCC)]: https://github.com/iovisor/bcc
[contrib/ebpf-tracing]: ../contrib/ebpf-tracing/

## Tracepoint documentation

The currently avaliable tracepoints are listed here.
...
the tracepoint. See existing examples in [contrib/ebpf-tracing/].
...
Multiple tools can list the avaliable tracepoints in a `bitcoind` binary with
USDT support.
