...
struct MainSignalsInstance {
    ...
    boost::signals2::signal<void (const CTransactionRef &, const CAmount nFee)> TransactionAddedToMempoolWithFee;
...
void CMainSignals::TransactionAddedToMempoolWithFee(const CTransactionRef &ptx, const CAmount nFee) {
    m_internals->m_schedulerClient.AddToProcessQueue([ptx, nFee, this] {
        m_internals->TransactionAddedToMempoolWithFee(ptx, nFee);
    });
}
