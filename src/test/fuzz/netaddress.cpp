...
FUZZ_TARGET(netaddress)
{
    ...
    if (net_addr.IsRFC3849() || net_addr.IsRFC3964() || net_addr.IsRFC4380() || net_addr.IsRFC4843() || net_addr.IsRFC7343() || net_addr.IsRFC4862() || net_addr.IsRFC6052() || net_addr.IsRFC6145() || net_addr.IsRFC9637() || net_addr.IsRFC6666() || net_addr.IsRFC5180() || net_addr.IsRFC8215() || net_addr.IsRFC9602()) {
        assert(net_addr.IsIPv6());
    }
    ...
    (void)net_addr.IsRFC8215();
    (void)net_addr.IsRFC9602();
