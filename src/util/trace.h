...
#define BITCOIN_DISABLE_WARN_ZERO_VARIADIC_POP
    ...
    #define TRACEPOINT(context, event, ...) \
	    ...
	    __dtrace_probe$##context##$##event##$v1$696e7436345f74$63686172202a$63686172202a$63686172202a$696e7436345f74$756e7369676e65642063686172202a(__VA_ARGS__); \
    ...
    #define TRACEPOINT_DEFINITION(context, event, ...) \
        extern "C" void __dtrace_probe$##context##$##event##$v1$696e7436345f74$63686172202a$63686172202a$63686172202a$696e7436345f74$756e7369676e65642063686172202a(__VA_ARGS__);
...
// Tracepoints
/*
TRACEPOINT_DEFINITION(net, inbound_message, int64_t, char *, char *, char *, int64_t, unsigned char *);
TRACEPOINT_DEFINITION(net, outbound_message, int64_t, char *, char *, char *, int64_t, unsigned char *);
