...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-zmqpubrawtxfee=<address>", "Enable publish raw transaction and its fee in <address>", ArgsManager::ALLOW_ANY, OptionsCategory::ZMQ);
    ...
    argsman.AddArg("-zmqpubrawtxfeehwm=<n>", strprintf("Set publish raw transaction outbound message high water mark (default: %d)", CZMQAbstractNotifier::DEFAULT_ZMQ_SNDHWM), ArgsManager::ALLOW_ANY, OptionsCategory::ZMQ);
    ...
    hidden_args.emplace_back("-zmqpubrawtxfee=<address>");
    hidden_args.emplace_back("-zmqpubsequence=<n>");
    hidden_args.emplace_back("-zmqpubhashblockhwm=<n>");
    hidden_args.emplace_back("-zmqpubhashtxhwm=<n>");
    hidden_args.emplace_back("-zmqpubrawblockhwm=<n>");
    hidden_args.emplace_back("-zmqpubrawtxhwm=<n>");
    hidden_args.emplace_back("-zmqpubrawtxfeehwm=<n>");
