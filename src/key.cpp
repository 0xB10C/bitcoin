...
std::optional<EllSwiftPubKey> CKey::EllSwiftEncode(const std::array<uint8_t, 32>& rnd32) const
{
    EllSwiftPubKey encoded_pubkey;
    if (!secp256k1_ellswift_create(secp256k1_context_sign, encoded_pubkey.data(), keydata.data(), rnd32.data())) {
        return {};
    }
