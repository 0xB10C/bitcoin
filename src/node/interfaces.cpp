...
public:
    ...
    void TransactionAddedToMempool(const CTransactionRef& tx, uint64_t mempool_sequence, const CAmount fee) override
    {
        m_notifications->transactionAddedToMempool(tx, mempool_sequence, fee);
    }
...
public:
    ...
    void requestMempoolTransactions(Notifications& notifications) override
    {
        ...
        for (const CTxMemPoolEntry& entry : m_node.mempool->mapTx) {
            notifications.transactionAddedToMempool(entry.GetSharedTx(), 0 /* mempool_sequence */, entry.GetFee());
        }
    }
