...
class GetVersionTest (BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        minor = int((version["numeric"] - major * 10_000) / 100)
        build = int((version["numeric"] - major * 10_000 - minor * 100))
        ...
        # release_canidate: e.g. 0
        assert_equal(type(version["release_canidate"]), int)
